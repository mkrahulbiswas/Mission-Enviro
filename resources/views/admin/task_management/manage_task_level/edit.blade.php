...
<div class="row">
    <div class="col-sm-12">
        ...
        <h4 class="page-title">Edit Task Level</h4>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Edit Task Level</li>
        </ol>
    </div>
</div>
...
<div class="row">
    <div class="col-lg-12">
        <div class="card-box">
            ...
            <form id="updateManageTaskLevelForm" action="{{ route('update.manageTaskLevel') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row" style="padding: 0 15px;">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="dateFrom" placeholder="Eg: dd-mm-yyyy" class="form-control date-picker" value="{{ $data['dateFrom'] }}">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="dateTo" placeholder="Eg: dd-mm-yyyy" class="form-control date-picker" value="{{ $data['dateTo'] }}">
                ...
                <div class="form-group text-right m-b-0">
                    <button id="updateManageTaskLevelBtn" class="btn addBtn waves-effect waves-light" type="submit"><i class="ti-save"></i>
                        <span>Update</span>
                    </button>
                </div>
