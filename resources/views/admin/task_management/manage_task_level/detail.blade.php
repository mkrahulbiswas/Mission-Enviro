...
<div class="row">
    <div class="col-sm-12">
        ...
        <h4 class="page-title">Details Of Task Level</h4>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Details Of Task Level</li>
        </ol>
    </div>
</div>
                    ...
                    <div id="accordion">
                        ...
                        <div class="card">
                            <div class="card-header" id="headingTwo">
                                <h6 class="m-0">
                                    <a href="#collapseTwo" class="collapsed text-dark" data-toggle="collapse" aria-expanded="true" aria-controls="collapseTwo">Detail View Of Task Level</a>
                                </h6>
                            </div>
                            <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordion">
                                <div class="card-body">
                                    ...
                                    <!-- <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <lable class="font-weight-bold">Point's: &nbsp;&nbsp;</lable>{{ $data['point'] }}
                                            </div>
                                        </div>
                                    </div> -->
