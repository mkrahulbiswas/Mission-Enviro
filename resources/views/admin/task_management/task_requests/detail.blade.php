...
<div class="row">
    <div class="col-sm-12">
        ...
        <h4 class="page-title">Details Of Requests</h4>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="JavaScript:void(0);">Task Management</a></li>
            <li class="breadcrumb-item"><a href="{{route('show.taskRequests')}}">Task Requests</a></li>
            <li class="breadcrumb-item active">Details Of Requests</li>
        </ol>
    </div>
</div>
                    ...
                    <div id="accordion">
                        ...
                        <div class="card">
                            <div class="card-header" id="headingTwo">
                                <h6 class="m-0">
                                    <a href="#collapseTwo" class="collapsed text-dark" data-toggle="collapse" aria-expanded="true" aria-controls="collapseTwo">Detail View Request</a>
                                </h6>
                            </div>
                            <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordion">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <lable class="font-weight-bold">User Name: &nbsp;&nbsp;</lable>{!! $data['name'] !!}
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <lable class="font-weight-bold">Task Title: &nbsp;&nbsp;</lable>{!! $data['task'] !!}
                                            </div>
                                        </div>
                                    </div>
