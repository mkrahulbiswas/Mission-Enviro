...
<div class="row">
    <div class="col-sm-12">
        ...
        <h4 class="page-title">Edit Task Quarter</h4>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Edit Task Quarter</li>
        </ol>
    </div>
</div>
...
<div class="row">
    <div class="col-lg-12">
        <div class="card-box">
            ...
            <form id="updateManageTaskQuarterForm" action="{{ route('update.manageTaskQuarter') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row" style="padding: 0 15px;">
                    <div class="form-group col-md-3">
                        ...
                        <select name="taskLevel" id="taskLevel" class="advance-select-taskLevel">
                            ...
                            <option value="{{ $item->id }}" {{ ($item->id == $data['taskLevelId']) ? 'selected' : '' }} data-dateFrom="{{ date('d-m-Y', strtotime($item->dateFrom)) }}" data-dateTo="{{ date('d-m-Y', strtotime($item->dateTo)) }}">{{ $item->title }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" name="dateFrom" placeholder="Eg: dd-mm-yyyy" class="form-control date-picker-with-range" value="{{ $data['dateFrom'] }}">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" name="dateTo" placeholder="Eg: dd-mm-yyyy" class="form-control date-picker-with-range" value="{{ $data['dateTo'] }}">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" name="rankPoint" placeholder="E.g: 123" class="form-control" value="{{ $data['rankPoint'] }}" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                ...
                <div class="form-group col-md-12">
                    ...
                    <textarea type="text" name="description" cols="5" rows="5" id="description" placeholder="Description For Session" class="form-control">{{ $data['description'] }}</textarea>
                    <span role="alert" id="descriptionErr" style="color:red;font-size: 12px"></span>
                </div>

                <div class="form-group text-right m-b-0 col-md-12">
                    <button id="updateManageTaskQuarterBtn" class="btn addBtn waves-effect waves-light" type="submit"><i class="ti-save"></i>
                        <span>Update</span>
                    </button>
                </div>
