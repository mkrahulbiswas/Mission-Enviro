...
<div class="row">
    <div class="col-sm-12">
        ...
        <h4 class="page-title">Edit Did You Know</h4>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Edit Did You Know</li>
        </ol>
    </div>
</div>
...
<div class="row">
    <div class="col-lg-12">
        <div class="card-box">
            ...
            <form id="updateDidYouKnowForm" action="{{ route('update.didYouKnow') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group col-md-12">
                    ...
                    <input type="text" name="title" placeholder="Title Of Did You Know" class="form-control" value="{{ $data['title'] }}">
                    <span role="alert" id="titleErr" style="color:red;font-size: 12px"></span>
                </div>

                <div class="form-group col-md-12">
                    <label for="description">Description<span class="text-danger">*</span></label>
                    <textarea type="text" name="description" cols="5" rows="5" id="description" placeholder="Description Of Did You Know" class="form-control">{{ $data['description'] }}</textarea>
                    <span role="alert" id="descriptionErr" style="color:red;font-size: 12px"></span>
                </div>

                <div class="form-group text-right m-b-0">
                    <button id="updateDidYouKnowBtn" class="btn addBtn waves-effect waves-light" type="submit"><i class="ti-save"></i>
                        <span>Update</span>
                    </button>
                </div>
