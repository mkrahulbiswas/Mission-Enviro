...
<div class="row">
    <div class="col-sm-12">
        ...
        <h4 class="page-title">Details Of Did You Know</h4>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Details Of Did You Know</li>
        </ol>
    </div>
</div>
                    ...
                    <div id="accordion">
                        ...
                        <div class="card">
                            <div class="card-header" id="headingTwo">
                                <h6 class="m-0">
                                    <a href="#collapseTwo" class="collapsed text-dark" data-toggle="collapse" aria-expanded="true" aria-controls="collapseTwo">Detail View Of Fun Facts</a>
                                </h6>
                            </div>
