...
<div class="row">
    <div class="col-sm-12">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="{{ route('show.requestedJournal') }}">Requested Journal</a></li>
                    ...
                    <div id="accordion">
                        ...
                        <div class="card">
                            <div class="card-header" id="headingTwo">
                                <h6 class="m-0">
                                    <a href="#collapseTwo" class="collapsed text-dark" data-toggle="collapse" aria-expanded="true" aria-controls="collapseTwo">Detail View Requested Journal</a>
                                </h6>
                            </div>
