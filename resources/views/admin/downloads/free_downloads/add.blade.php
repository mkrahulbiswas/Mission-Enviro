...
<div class="row">
    <div class="col-lg-12">
        <div class="card-box">
            ...
            <form id="saveFreeDownloadsForm" action="{{route('save.freeDownloads')}}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group text-right m-b-0">
                    <button id="saveFreeDownloadsBtn" class="btn addBtn waves-effect waves-light" type="submit"><i class="ti-save"></i>
                        <span>Save</span>
                    </button>
                </div>
