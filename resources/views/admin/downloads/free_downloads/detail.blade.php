...
<div class="row">
    <div class="col-sm-12">
        ...
        <h4 class="page-title">Details Of File</h4>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Details Of File</li>
        </ol>
    </div>
</div>
                    ...
                    <div id="accordion">
                        ...
                        <div class="card">
                            <div class="card-header" id="headingTwo">
                                <h6 class="m-0">
                                    <a href="#collapseTwo" class="collapsed text-dark" data-toggle="collapse" aria-expanded="true" aria-controls="collapseTwo">Detail View File</a>
                                </h6>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <img src="{{ $data['file'] }}" class="img-fluid" height="100px" width="100px">
                                            </div>
                                        </div>
                                    </div>
