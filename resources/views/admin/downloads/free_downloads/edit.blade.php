...
<div class="row">
    <div class="col-sm-12">
        <div class="btn-group pull-right m-t-15">
            <a href="{{ route('show.freeDownloads') }}" class="btn addBtn waves-effect waves-light"><i class=" ti-arrow-left"></i> Back</a>
        </div>
        <h4 class="page-title">Edit File</h4>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="JavaScript:void(0);">Downloads</a></li>
            <li class="breadcrumb-item"><a href="{{route('show.freeDownloads')}}">Free Downloads</a></li>
...
<div class="row">
    <div class="col-lg-12">
        <div class="card-box">
            ...
            <form id="updateFreeDownloadsForm" action="{{ route('update.freeDownloads') }}" method="POST" enctype="multipart/form-data">
                @csrf

                <input type="hidden" name="id" value="{{ $data['id'] }}">

                <div class="form-group">
                    <label for="file"><strong>Note:&nbsp;</strong> Image format must be .jpg, .jpeg, .png<span class="text-danger">*</span></label>
                    <div class="row">
                ...
                <div class="form-group text-right m-b-0">
                    <button id="updateFreeDownloadsBtn" class="btn addBtn waves-effect waves-light" type="submit"><i class="ti-save"></i>
                        <span>Update</span>
                    </button>
                </div>
