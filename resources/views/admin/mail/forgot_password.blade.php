...
<table cellpadding="0" cellspacing="0" align="center" bgcolor="#ffffff" style="max-width:640px;min-width:320px"> 
   <tbody>
    ...
    <tr> 
     <td align="left" style="font-family:Arial,Helvetica,sans-serif;font-size:15px;font-weight:bold;color:#52555a;padding-left:10px;padding-right:10px">Hello {{$name}}</td> 
    </tr> 
     ...
     <td align="center"> 
      <table width="500" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#f7f7f7" style="border-radius:8px;border:0px solid #bcbcbc"> 
       <tbody>
        ...
        <tr> 
         <td style="font-family:Arial,Helvetica,sans-serif;font-size:15px;text-align:left;color:#52555a;padding-left:10px;padding-right:10px">Your OTP is: {{$otp}}</td> 
        </tr> 
        <tr> 
         <td height="30"></td> 
        </tr> 
